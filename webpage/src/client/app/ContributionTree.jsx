    ...
    return (
      <div className="bordered-box">
          <table>
            ...
            <tbody>
              <tr className="tree-entity" style={{display: this.state.path === '.' ? 'none' : ''}}>
                <td colSpan="2" className="underline-hover" onClick={this.backtrackSubFolder.bind(this)}>..</td>
              </tr>
